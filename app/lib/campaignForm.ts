...
export const campaignFormSurvey: SurveyConfig = {
  ...
  steps: [
    ...
    },
    {
      id: 3,
      question:
        "چه kpi هایی برای این کمپین مدنظر دارید تا برسی شود. (kpi هایی که مشاهده میکنید از اصلی ترین های kpi های مختص کمپین انتخاب شده شما هستند)",
      type: "checkbox",
      optionsFromParent: {
        parentQuestion: "نوع کمپین مدنظر خود را مشخص کنید",
        optionMap: {
          "کمپین Awareness": [
            "Brand Association",
            "Brand Impressions",
