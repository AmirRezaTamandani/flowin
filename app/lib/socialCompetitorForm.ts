  ...
  steps: [
    {
      id: 1,
      question:
        "با چه هدفی می‌خواهید تحلیل رقبای شبکه‌های اجتماعی انجام دهید؟",
      type: "checkbox",
    ...
    },
    {
      id: 2,
      question:
        "لینک صفحات رسمی و فعال برند خود در شبکه‌های اجتماعی را وارد کنید. هر لینک را در یک خط جداگانه بنویسید.",
      type: "textarea",
      placeholder:
        "مثال:\nاینستاگرام | https://instagram.com/username\nلینکدین | https://linkedin.com/company/brand\nتلگرام | https://t.me/brand",
    },
    {
      id: 3,
      question:
      ...
      type: "textarea",
      placeholder:
        "هر رقیب در یک خط:\nنام رقیب | اولویت (1-10) | پلتفرم: لینک\nمثال:\nبرند الف | 1 | اینستاگرام: https://instagram.com/brand-a | لینکدین: https://linkedin.com/company/brand-a",
    },
    {
      id: 4,
      question:
