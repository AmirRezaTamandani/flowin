...
export const socialStrategyFormSurvey: SurveyConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      id: 5,
      question:
        "محصولات یا خدماتی که می‌خواهید در ماه آینده تمرکز محتوایی بیشتری روی آن‌ها داشته باشیم کدام‌اند؟ لطفاً برای هر مورد، سهم تقریبی آن از محتوای ماه آینده را مشخص کنید. مجموع درصدها باید ۱۰۰٪ باشد. (اگر کسب‌وکار شما چندبرندی یا مارکت‌پلیس است، نام محصول را همراه با جزئیاتی مثل دسته محصول یا برند وارد کنید.)",
      type: "repeater",
      repeaterFields: [
